...
class Skull extends en.Mob {
    ...
    public static function create(arg0: pr.Level, arg1: Int, arg2: Int, arg3: Int, arg4: Int): en.mob.Skull {
    ...
    public function wallHit(arg0: Entity): Void {
    }
