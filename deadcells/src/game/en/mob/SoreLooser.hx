...
class SoreLooser extends en.Mob {
    ...
    public static function create(arg0: pr.Level, arg1: Int, arg2: Int, arg3: Int, arg4: Int): en.mob.SoreLooser {
    ...
    public function tryPrepare(arg0: tool.skill.MobSkill): Void {
    }
