...
class Scarecrow extends en.Mob {
    ...
    public var da: Float;
    public var firstHit: Float;
    public var lastHit: Float;
    public var totalDmg: Float;
    public var avg: Float;
    public var highest: Float;
    public var canLog: Bool;
    public var lastWeaponHit: tool.InventItem;
    public var stringBuf: StringBuf;
    ...
    public static function create(arg0: pr.Level, arg1: Int, arg2: Int, arg3: Int, arg4: Int): en.mob.Scarecrow {
